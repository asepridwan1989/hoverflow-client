<template>
  <div>
    ...
    <div class="card-body">
      <router-link :to="{ name: 'articledetail', params: { id: article._id }}"><h5 class="card-title">{{article.title}}</h5></router-link>   
       <router-view/>   
      <h6 class="card-subtitle mb-2 text-muted">posted by: {{article.userId}}</h6>
